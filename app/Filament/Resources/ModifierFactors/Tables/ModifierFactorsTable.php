...
namespace App\Filament\Resources\ModifierFactors\Tables;
    ...
    public static function configure(Table $table): Table
    {
        return $table
            ->columns([
                ...
                \Filament\Tables\Columns\TextColumn::make('multiplier')->searchable()->sortable(),
